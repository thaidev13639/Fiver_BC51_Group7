...
import Button from '../JobsDetail/components/Button'
import StyleSwitch from '../JobsDetail/components/StyleSwitch'
            ...
            return (
                <div>
                    <div style={{ marginBottom: "20px" }}>
                        ...
                        <span style={{ marginLeft: "10px" }} className='text-danger'> (*) Can't Found Information You Want</span>
                    </div>
                    <img style={{ width: "100%" }} src={require('../../images/imgHome/R.png')} alt="Page Not Found" />
                </div>
            )
        }
    }
